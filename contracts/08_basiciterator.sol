...
contract BasicIterator {
    ...
    uint8[100] integers;               // reserve a chunk of storage for 10 8-bit unsigned integers in an array
    ...
    function getSum() 
    public
    constant returns (uint)  // "constant" just means this function returns something to the caller
